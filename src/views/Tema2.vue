...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Los tipos de interfaz de usuario más conocidos son:
    .row.align-items-center.mb-5
      ...
      .col-xxl-3.col-xl-4.d-none.d-xl-block
    ...
    p.mb-5 Las redes inalámbricas tienen diversas características dependiendo del rango de frecuencias, el medio y la velocidad de transmisión, entre las cuales están:
    ...
    p.mb-5 #[strong En concreto, dentro de las características adicionales, se encuentran:]
    ...
    p.mb-5 El siguiente video, detalla generalidades y aspectos clave sobre la configuración del control parental. Chequéelo con atención:
    ...
    p Como es de esperar, este tipo de sistema de control parental de Windows 10 solo funciona en navegadores Microsoft Edge y Explorer; para evitar el uso de otro navegador se puede bloquear como se mencionó antes o, también, instalar el control parental del que también disponen Google Chrome o Mozilla Firefox.

    p.mb-5 #[strong Estas son algunas generalidades que, sobre el control parental de Windows 10, usted debe tener presentes:]
    ...
    .bg-slyde-gradiente-2.mb-5
      p.mb-4.pt-4 #[strong El video que se muestra enseguida, expone las generalidades de configuración de wifi para invitados:]
    ...
    p.mb-5 Si se realiza una prueba de velocidad con una conexión ADSL en la que se tiene a toda la familia conectada y viendo videos de YouTube, por ejemplo:

    .row.mb-5.justify-content-center.mb-5
      .col-xl-11
        .row.justify-content-center
          .col-xl-4.col-lg.mb-5.mb-lg-0
    ...
    p.mb-5 De esta manera se puede crear una red wifi para invitados. Una forma práctica para que las visitas se puedan conectar a la red sin revelar la clave principal, ni poner en peligro el resto de los equipos conectados a la red.
    ...
    p.mb-5 Cambie la prioridad de los adaptadores de red en Windows 10 desde el centro de redes de este sistema operativo. Lo primero que se debe hacer es abrir el centro de redes y recursos compartidos, para ello, en el siguiente video se explicará la configuración de la prioridad de medios.
